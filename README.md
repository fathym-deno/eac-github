...
- **Goal:** model GitHub resources and automation as EaC for reuse across Fathym runtimes.
...
3. Capture provenance/release channels in `UPSTREAM.md` when publishing to jsr/npm; note GitHub API/version assumptions.
